...
class CrazyflieSIL:
    ...
    def cmdVelHover(self, roll,pitch,yawrate,z):
        self.mode = CrazyflieSIL.MODE_LOW_VELOCITY
        # self.setpoint.position.x = 1
        # self.setpoint.position.y = 0.0
        self.setpoint.position.z = z
        self.setpoint.velocity.x = pitch
        self.setpoint.velocity.y = roll
        self.setpoint.velocity.z = 0.0
        # self.setpoint.attitude.yaw = yawrate
    ...
    def cmdRPYHover(self,roll,pitch,yawrate,z):
        self.mode = CrazyflieSIL.MODE_LOW_VELOCITY
